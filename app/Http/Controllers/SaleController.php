...
class SaleController extends Controller
{
    ...
    public function getProduct($id)
    {
        ...
        foreach ($lims_product_warehouse_data as $product_warehouse) 
        {
            ...
            $alert_quantity[] = $product_warehouse->alert_quantity;
        ...
        $product_data = [$product_code, $product_name, $product_qty, $product_type, $product_id, $product_list, $qty_list, $product_price, $alert_quantity];
        return $product_data; 
    }
